...
snakemake -s blast_fugu.snake  --jobname "{rulename}.{jobid}" --profile profile \
  --groups blast_on_fugu_file=group0 --group-components group0=16 -w 100 --jobs 100 -p -k \
  --restart-times 1 --rerun-incomplete-w 100 --jobs 100 -p -k --restart-times 1 --rerun-incomplete
